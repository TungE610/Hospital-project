...
const BillModal = (props) => {
  ...
  const { Option } = Select;
  const [medical1,setMedical1] = useState('Vitamin');
  const [medical2,setMedical2] = useState('Vitamin');
  const [medical3,setMedical3] = useState('Vitamin');
  ...
  const endupSuccessNotification = () => {
      notification["success"]({
        message: 'SUCCESSFULL',
        description:`You have just successfully make a bill and end up appointment!!`,
      });
    };
  ...
  const makeNewSuccessNotification = () => {
      notification["success"]({
        message: 'SUCCESSFULL',
        description:`Successfully make new appointment`,
      });
    };
  ...
  const failNotification = () => {
      notification["error"]({
        ...
        description:'All room being full. I\'m sorry!!',
      });
    };
